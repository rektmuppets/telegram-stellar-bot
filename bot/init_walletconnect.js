...
// Dynamically resolve the .env file path in the project root
...
if (!fs.existsSync(envPath)) {
  ...
  process.exit(1); // Exit if .env is missing
} else {
...
if (!projectId) {
  ...
  throw new Error("PROJECT_ID is required in .env to initialize WalletConnect.");
}
