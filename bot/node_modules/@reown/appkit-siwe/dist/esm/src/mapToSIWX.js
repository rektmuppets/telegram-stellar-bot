    ...
    return {
        ...
        async getSessions(chainId, address) {
            try {
                ...
                const isNetworkMismatch = shouldSignOutOnNetworkChange && siweCaipNetworkId !== requestedCaipNetworkId;
                const isAddressMismatch = shouldSignOutOnAccountChange && !HelpersUtil.isLowerCaseMatch(sessionAddress, address);
